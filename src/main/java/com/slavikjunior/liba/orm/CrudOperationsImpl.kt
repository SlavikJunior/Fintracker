...
import com.slavikjunior.liba.dao.UniversalDaoOperations
...
class CrudOperationsImpl(
    ...
    override fun <T : Entity> create(entity: T, idIsAutoGenerate: Boolean): Boolean {
        ...
        return method?.invoke(UniversalDaoOperations(entity::class.java), entity.toFieldMapByColumnNames()) as Boolean
    }
...
//        return Class.forName(daoClassName)
        return UniversalDaoOperations::class.java
    }
